...
$router->addRoute("GET", "/posts/create", [PostController::class, 'create']);
$router->addRoute("POST", "/posts", [PostController::class, 'store']);
$router->addRoute("GET", "/posts/{id}", [PostController::class, 'show']);
$router->addRoute("GET", "/posts/{id}/edit", [PostController::class, 'edit']);
$router->addRoute("POST", "/posts/{id}", [PostController::class, 'update']);
$router->addRoute("POST", "/posts/{id}/delete", [PostController::class, 'delete']);
